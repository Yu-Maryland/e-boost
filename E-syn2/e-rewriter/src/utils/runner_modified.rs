    ...
    IterData: IterationData<L, N>,
{
    ...
    where
        ...
        L: 'a,
        N: 'a,
        <N as egg::Analysis<L>>::Data: Serialize, // Add this constraint
    {
        ...
        loop {
            ...
            // parrallel version
            // Execute egraph.rebuild() every 5 rounds
            // iteration_count += 1;
            ...
            //         .clone()
            //         .into_iter()
            //         .map(|id| serde_json::Value::String(id.to_string())) // Convert integers to strings
            //         .collect();
            ...
            // Check limit conditions and stop reasons after iteration completes
